        ...
        body: Column(
          ...
          children: [
            Container(
              ...
              child: Image.asset("aseets/songlist/love/lovep.jpeg",
                  fit: BoxFit.cover),
            ),
            Padding(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              Text("${sname}",
                  style: GoogleFonts.poppins(
                      color: Colors.white70, letterSpacing: 1, fontSize: 11)),
              Text("${aname}",
                  style: GoogleFonts.poppins(
                      color: Colors.white60, letterSpacing: 1, fontSize: 8)),
            ],
          ),
          Spacer(),
